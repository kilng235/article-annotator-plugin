...
var LANGUAGES = {
  ...
  "settings": {
    ...
    "aboutText": "Article Annotator v0.1.15 — Inspired by Microsoft Word comments. All annotation data is stored independently and does not modify the original file. Currently supports Desktop, iPad, and Android — manual sync required across devices. Automatic sync coming soon.",
  },
  "colorNames": {
    "#FCD34D": "Warm Yellow",
    "#FBBF24": "Amber",
  ...
  "settings": {
    ...
    "aboutText": "文章批注 v0.1.15 — 参考 Microsoft Word 批注设计。所有批注数据独立保存，不修改原文。目前支持电脑、iPad、手机三端使用，跨设备需手动同步，自动同步功能后续更新。",
  },
  "colorNames": {
    "#FCD34D": "暖黄",
    "#FBBF24": "琥珀",
